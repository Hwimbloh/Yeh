...
jQuery(document).ready(function () {
    ...
    jQuery(".viewyprod").on("tap", function () {
        ...
        if (prez == 'yes') {
            ...
            jQuery("#Ic" + z + "").html(" ");
            jQuery("#Ic" + z + "").html('<img  src= "images/default.jpg"/>');
            pogihide();
    ...
    jQuery(".viewyserv").on("tap", function () {
        ...
        if (prez == 'yes') {
            ...
            jQuery("#Id" + z + "").html(" ");
            jQuery("#Id" + z + "").html('<img  src= "images/default.jpg"/>');
            pogihide();
    ...
    jQuery(".viewywprod").on("tap", function () {
        ...
        if (prez == 'yes') {
            ...
            jQuery("#Iccc" + z + "").html(" ");
            jQuery("#Iccc" + z + "").html('<img  src= "images/default.jpg"/>');
            pogihide();
    ...
    jQuery(".viewywserv").on("tap", function () {
        ...
        if (prez == 'yes') {
            ...
            jQuery("#Iddd" + z + "").html(" ");
            jQuery("#Iddd" + z + "").html('<img  src= "images/default.jpg"/>');
            pogihide();
    ...
    jQuery("#country").on("tap", function () {

        alert("Scroll Down The List to Find Your Country...Please Select The Correct Country.");
                ...
                jQuery.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data != "failed" && data.length != 0) {
                            ...
                            alert("Welcome To NetWek " + localStorage.netwekname + "...Your NetWek ID Is : " + localStorage.uid + "...Please Save It In Your Contacts As NetWek ID For Use As Your Password.");
    ...
    jQuery("#searchprod").submit(function (event) {
        ...
        if (productshop == true) {
            ...
            jQuery.ajax({
                type: "POST",
                url: "http://192.168.92.1/server/search/searchprod.php",
                data: params,
                dataType: 'json',
                crossDomain: true,
                cache: false,
                success: function (data) {
                    if (data.length == 0) {
                        ...
                        jQuery.each(data, function (i, item) {
                            ...
                            jQuery("#Ic" + z + "").html('<img src="images/VIEW.jpeg" />');
    ...
    jQuery("#searchserv").submit(function (event) {
        ...
        if (serviceshop == true) {
            ...
            jQuery.ajax({
                type: "POST",
                url: "http://192.168.92.1/server/search/searchserv.php",
                data: params,
                dataType: 'json',
                crossDomain: true,
                cache: false,
                success: function (data) {
                    if (data.length == 0) {
                        ...
                        jQuery.each(data, function (i, item) {
                            ...
                            jQuery("#Id" + z + "").html('<img src="images/VIEW.jpeg" />');
    ...
    jQuery("#searchwprod").submit(function (event) {
        ...
        if (wproductshop == true) {
            ...
            jQuery.ajax({
                type: "POST",
                url: "http://192.168.92.1/server/search/searchwprod.php",
                data: params,
                dataType: 'json',
                crossDomain: true,
                cache: false,
                success: function (data) {
                    if (data.length == 0) {
                        ...
                        jQuery.each(data, function (i, item) {
                            ...
                            jQuery("#Iccc" + z + "").html('<img src="images/VIEW.jpeg" />');
    ...
    jQuery("#searchwserv").submit(function (event) {
        ...
        if (wserviceshop == true) {
            ...
            jQuery.ajax({
                type: "POST",
                url: "http://192.168.92.1/server/search/searchwserv.php",
                data: params,
                dataType: 'json',
                crossDomain: true,
                cache: false,
                success: function (data) {
                    if (data.length == 0) {
                        ...
                        jQuery.each(data, function (i, item) {
                            ...
                            jQuery("#Iddd" + z + "").html('<img src="images/VIEW.jpeg" />');
