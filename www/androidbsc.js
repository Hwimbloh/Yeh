...
jQuery(document).ready(function () {
  ...
  if(data.indexOf("Maximum") != -1 || data.indexOf("error")!= -1 || data.indexOf("exceeded")!= -1 ){
                    ...
                    datacon();
                       ...
                       else  if (data != "no" && data.indexOf("Maximum") == -1 && data.indexOf("error")== -1 && data.indexOf("exceeded")== -1 ) {
     ...
     jQuery("#goTerm").on("tap", function () {

             setTimeout(pogihide, 2000);
...
else if (data.indexOf("Maximum") != -1 || data.indexOf("error")!= -1 || data.indexOf("exceeded")!= -1) {
...
datacon();
        ...
        function fetcho() {
            ...
            window.setTimeout(fetcho, 300000);
        ...
        function showchats() {
            ...
            try {
                ...
                if (uid != " ") {
					...
					window.setTimeout(showchats, 5000);
...
localStorage.well = "no";
                ...
                var updated = localStorage.updated;
                    ...
                    datacon();
                                 ...
                                 else   if (data != "failed" && data.length != 0 && data.indexOf("Maximum") == -1 && data.indexOf("error")== -1 && data.indexOf("exceeded")== -1) {
