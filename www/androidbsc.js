...
jQuery(document).ready(function () {
    ...
    if (logo == "yes" && uid.length != 0) {
        ...
        localStorage.localhost = "192.168.43.159";
    ...
    function getmessage(z, munhu, mess) {
        ...
        jQuery.ajax({
            type: "POST",
            url: "http://" + localStorage.localhost +  "/server/erge/messagesface.php",
            dataType: 'json',
            data: params,
            crossDomain: true,
            cache: false,
    ...
    function ghettomessage() {
        ...
        jQuery.ajax({
            type: "POST",
            url: "http://" + localStorage.localhost +  "/server/erge/messages.php",
            dataType: 'json',
            data: params,
            crossDomain: true,
            cache: false,
